...
class ForceManRegistrationScreen extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: const Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("फोर्स मैन के लिए पंजीकरण",
                            style: TextStyle(
                                color: Colors.white,
                                fontSize: 20,
                                fontWeight: FontWeight.w800)),
                        SizedBox(height: 4),
                        Text("Register for Force Man",
                ...
                Obx(() =>
                    DropdownButtonFormField<DistrictModel>(
                      ...
                      items: globalcontroller.districts
                          ...
                          .toList(),
                      onChanged: (d) =>
                      globalcontroller.selectedDistrict.value =
                          d,
                      validator: (v) => v == null ? "Required" : null,
                    )),
                ...
                _text(nomineeMobileC, "Nominee Mobile *",
                    type: TextInputType.phone),
  ...
  //   final uri = Uri.parse(
  //     "upi://pay?pa=yourupi@bank&pn=ForceMan&am=100&cu=INR",
  //   );

...
//   var merchantSubscriptionId=''.obs;
//
...
//     print("sfknldnlnfkds :${subsid.toString()}");
//
//
//
...
//         startTransaction(amount,merchantSubscriptionId.toString(),merchantOrderId.value);
//       }
//
...
//       print("❌ Error: $e");
//     }
//     checkOrderStatus(merchantOrderId.value);
//   }
//
//
//
//
//   Future<void> redeemSubscriptionnotifyexecute() async {
//     // final String merchantOrderId =
//     //     "MO${DateTime.now().millisecondsSinceEpoch}";
//
//     final body = {
...
//     SharedPreferences prefs = await SharedPreferences.getInstance();
//
//     String? subsid = prefs.getString("lastmerchsubsid");
//
//     print("Subscription ID: $subsid");
//
...
//
//     final url =
//         "https://api-preprod.phonepe.com/apis/pg-sandbox/subscriptions/v2/$subsid/cancel";
//
//     try {
//       final res = await Dio().post(
//         url,
...
//             "Content-Type": "application/json",
//             "Authorization": "O-Bearer ${accessToken.value}",
//             // 👉 Required ONLY if partner integration
//             "X-MERCHANT-ID": "${ServerConstants.PHONEPE_MERCHANT_ID}",
//           },
//         ),
//       );
//
...
//       } else {
//         print("⚠️ Unexpected Response: ${res.data}");
//       }
//
//     } on DioException catch (e) {
//       print("❌ Dio Error: ${e.response?.data ?? e.message}");
